<!DOCTYPE html>
<html lang="en">
<meta charset="UTF-8meta name="viewport" content="width=device-width, initial-scale=1.0" <title>Post-SCT Day +100 — Healthy Living Roadmap</title>
href="https://fonts.googleapis.c2?family=DM+Serif+Display:ital@0;1&family=DM+Mono:wght@300;400;500&family=Instrument+Sans:wght@400;500;600&display=swap" rel="stylesheet"<style>  --bg: #f4f0e-ink: #1a141--accent: #c44b2b;
    --gold: #d4952a;
    --sage: #4a7c59;
    --sky: #2e6b8a;
    --lavender: #6b5b8a;
